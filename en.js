...
Store ID: ${ext.store}`,
    ...
    FREE_SOFTWARE_DESCRIPTION:                      "tt.bot is free software licensed under the [GNU AGPLv3 or later](https://owo.codes/tt.bot/_/-/blob/master/LICENSE). Translations for tt.bot are licensed under the [MIT License](https://github.com/tt-bot-dev/languages/blob/master/LICENSE).",
    //#endregion events
